...
#include "../Circuito_Qt_incompleto/maincircuito.h"
...
QT_MOC_LITERAL(9, 174, 24) // "on_tableSaidas_activated"
    ...
    "on_tablePortas_activated\0index\0"
...
void MainCircuito::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        MainCircuito *_t = static_cast<MainCircuito *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject MainCircuito::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_MainCircuito.data,
      qt_meta_data_MainCircuito,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MainCircuito::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MainCircuito.stringdata0))
        return static_cast<void*>(const_cast< MainCircuito*>(this));
